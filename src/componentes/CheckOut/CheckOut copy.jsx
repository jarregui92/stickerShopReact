                    ...
                    <div className="bg-white lg:block hidden">
                        ...
                        <div className="px-8 border-b">
                            <div className="flex justify-between py-4 text-gray-600">
                                <span>Subtotal</span>
                                <span className="font-semibold text-pink-500">USD total compra</span>
                            </div>
                            <div className="flex justify-between py-4 text-gray-600">
                                <span>Costos de Envio</span>
                                <span className="font-semibold text-pink-500">USD costo envio</span>
                            </div>
                        </div>
                        <div className="font-semibold text-xl px-8 flex justify-between py-8 text-gray-600">
                            <span>Total</span>
                            <span className="font-semibold text-pink-500">USD costo + total</span>
                        </div>
                    </div>
                </div>
            </div>
